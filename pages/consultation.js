...
const Consultation = () => {
  ...
  return (
    <div>
      <Snackbar handleClose={handleClose} message={snackbarMessage} open={isSnackbarOpen} severity={snackbarSeverity} />
      <Progress open={loading}/>
      {user?.email && (
        <Drawer>
          <>
            <Stack direction="row" spacing={20} justifyContent="space-between" alignItems="center" sx={{width: '100%', paddingBottom: '20px'}}>
              <Typography variant="h5" gutterBottom sx={{
                fontWeight: "bold"
              }}>
                Consultations
              </Typography>
              <Button  variant="contained" onClick={toggleDrawer(true)}>New Consultation</Button>
            </Stack>
            ...
            <Backdrop toggleDrawer={toggleDrawer} isOpen={isOpen}>
              ...
              >
                <Stack direction="row" spacing={50} justifyContent="space-between" alignItems="center" sx={{width: '100%'}}>
                  <Typography variant="h5" gutterBottom sx={{
                    fontWeight: "bold"
                  }}>
                    New Consultation
